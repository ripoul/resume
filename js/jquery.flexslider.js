...
(function ($) {
  ...
  $.flexslider = function (el, options) {
    ...
    methods = {
        ...
        setup() {
          ...
          if (!msGesture) {
            ...
            slider.slides.each(function () {
              ...
              that.addEventListener('MSPointerDown', (e) => {
                e.preventDefault();
      ...
      directionNav: {
        setup() {
          const directionNavScaffold = $(`<ul class="${namespace}direction-nav"><li><a class="${namespace}prev" href="#">${slider.vars.prevText}</a></li><li><a class="${namespace}next" href="#">${slider.vars.nextText}</a></li></ul>`);
      ...
      pauseInvisible: {
        ...
        init() {
          ...
          if (methods.pauseInvisible.visProp) {
            const evtname = `${methods.pauseInvisible.visProp.replace(/[H|h]idden/, '')}visibilitychange`;
      ...
      if (!fade) {
        ...
        if (type === 'init') {
          if (!touch) {
            ...
            slider.slides.css({
              opacity: 0, display: 'block', webkitTransition: `opacity ${slider.vars.animationSpeed / 1000}s ease`, zIndex: 1,
    ...
    slider.doMath = function () {
      ...
      const { minItems } = slider.vars;
      const { maxItems } = slider.vars;
